...
def calc_offgas(bv,AF2, co2_in_cal1=False,o2_in_cal1=False,co2_in_cal2=False,o2_in_cal2=False):
...
def read_offGasData(blueVis_filePath, AF1, AF2=None, co2_in_cal1=False,o2_in_cal1=False,co2_in_cal2=False,o2_in_cal2=False,yn_in1=False,yn_in2=False):
    '''
    ...
    df = merge_dfs(blueVisData_use,AF1,AF2)
    ...
    df = calc_offgas(df,AF2,co2_in_cal1,o2_in_cal1,co2_in_cal2,o2_in_cal2)
