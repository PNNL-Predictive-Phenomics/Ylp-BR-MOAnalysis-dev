...
The Juptyer Notebook containing the analysis can be found [here](analysis.ipynb).
...
This repository contains a included `conda` [environment file](environment.yml) for easy dependency resolving.
...
Then boot up the `conda` environment (and potentially `jupyter` instance) as usual. Make sure to start the jupyter notebook from within this folder `valpasAnalysis` as the [analysis Notebook](analysis.ipynb) contains relative filepaths based on this foledr as the rootfolder.
